...
function ThemeParkDetails() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-blue-900 text-white px-4 py-8">
      <h1 className="text-4xl md:text-5xl font-extrabold text-center mb-8 bg-gradient-to-r from-blue-400 to-purple-600 text-transparent bg-clip-text">
        {parkDetails.name}
      </h1>

      {/* Park Image and Wikipedia Link */}
