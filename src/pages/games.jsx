...
export default function Games() {
  ...
  {games.map((game, index) => (
    <div
      key={index}
      className="bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-700 hover:bg-indigo-600 hover:cursor-pointer transition transform duration-200 w-full md:w-1/2 lg:w-1/3"
